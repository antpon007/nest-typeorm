...
--
-- Host: database-dreambank.cvcchelpilam.us-east-1.rds.amazonaws.com    Database: database-dreambank
-- ------------------------------------------------------
...
CREATE TABLE `product_request` (
  ...
  CONSTRAINT `product_request_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2022-05-08 20:04:45
